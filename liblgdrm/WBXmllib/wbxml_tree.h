...
typedef struct WBXMLTreeClbCtx_s {
    ...
    XML_Parser_drm     xml_parser;    /**< Pointer to Expat XML Parser */
 ...
 */
WBXMLTreeNode * wbxml_tree_node_elt_get_from_name(WBXMLTreeNode *node,
                                                                 const char *name,
                                                                 WB_BOOL recurs);
 ...
 */
WB_BOOL wbxml_tree_add_node(WBXMLTree *tree,
